...
"
.cm-s-dark2 { background: #262626; color: #EBEFE7; text-shadow: 0 -1px 1px #262626; }
.cm-s-dark2 div.CodeMirror-selected {background: #45443B !important;} /* 33322B*/
.cm-s-dark2 .CodeMirror-cursor { border-left: 1px solid white !important; }
.cm-s-dark2 .CodeMirror-lines { margin-left:3px; margin-right:3px; }/*editable code holder*/

div.CodeMirror .cm-s-dark2 span.CodeMirror-matchingbracket { color: #7EFC7E; }/*65FC65*/

.cm-s-dark2 .CodeMirror-gutter { background: #262626; border-right:1px solid #aaa; padding-right:3px; min-width:2.5em; }
...
(def output-file "/Users/jeremyschoffen/.lighttable/css/themes/dark2.css")
...
(defn write-css []
  (compile-css (partial spit output-file)))
